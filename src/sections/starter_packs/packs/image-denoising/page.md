...
filtered_df = df[df['Keywords'].str.contains('Image denoising', na=False)].copy()
...
df = df[df['Keywords'].str.contains('Image denoising', na=False)].copy()
...
filtered_df = df[df['Used for'].str.contains('Image denoising', na=False)].copy()
